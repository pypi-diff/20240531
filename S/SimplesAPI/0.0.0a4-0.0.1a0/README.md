# Comparing `tmp/simplesapi-0.0.0a4.tar.gz` & `tmp/simplesapi-0.0.1a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "simplesapi-0.0.0a4.tar", max compression
+gzip compressed data, was "simplesapi-0.0.1a0.tar", max compression
```

## Comparing `simplesapi-0.0.0a4.tar` & `simplesapi-0.0.1a0.tar`

### file list

```diff
@@ -1,8 +1,6 @@
--rw-r--r--   0        0        0      471 2024-05-31 03:10:57.860463 simplesapi-0.0.0a4/pyproject.toml
--rw-r--r--   0        0        0       12 2024-05-30 15:30:50.326578 simplesapi-0.0.0a4/README.md
--rw-r--r--   0        0        0      173 2024-05-31 00:45:34.171209 simplesapi-0.0.0a4/simplesapi/__init__.py
--rw-r--r--   0        0        0      918 2024-05-31 00:43:10.780386 simplesapi-0.0.0a4/simplesapi/app.py
--rw-r--r--   0        0        0     1340 2024-05-30 15:29:16.921041 simplesapi-0.0.0a4/simplesapi/auto_routing.py
--rw-r--r--   0        0        0      143 2024-05-31 03:10:28.959674 simplesapi-0.0.0a4/simplesapi/lifespan.py
--rw-r--r--   0        0        0     1091 2024-05-31 00:46:33.986007 simplesapi-0.0.0a4/simplesapi/settings.py
--rw-r--r--   0        0        0      566 1970-01-01 00:00:00.000000 simplesapi-0.0.0a4/PKG-INFO
...
### Comparing `simplesapi-0.0.0a4/simplesapi/auto_routing.py` & `simplesapi-0.0.1a0/simplesapi/auto_routing.py`
