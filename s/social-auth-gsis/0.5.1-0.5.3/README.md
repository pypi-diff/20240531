# Comparing `tmp/social_auth_gsis-0.5.1.tar.gz` & `tmp/social_auth_gsis-0.5.3.tar.gz`
...
## Comparing `social_auth_gsis-0.5.1.tar` & `social_auth_gsis-0.5.3.tar`
...
### Comparing `social_auth_gsis-0.5.1/README.md` & `social_auth_gsis-0.5.3/README.md`

 * *Files identical despite different names*

### Comparing `social_auth_gsis-0.5.1/social_auth_gsis/backends.py` & `social_auth_gsis-0.5.3/social_auth_gsis/backends.py`

 * *Files identical despite different names*

### Comparing `social_auth_gsis-0.5.1/social_auth_gsis/pipeline/social_auth.py` & `social_auth_gsis-0.5.3/social_auth_gsis/pipeline/social_auth.py`

 * *Files identical despite different names*

### Comparing `social_auth_gsis-0.5.1/setup.py` & `social_auth_gsis-0.5.3/PKG-INFO`
