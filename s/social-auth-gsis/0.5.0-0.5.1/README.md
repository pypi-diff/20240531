# Comparing `tmp/social_auth_gsis-0.5.0.tar.gz` & `tmp/social_auth_gsis-0.5.1.tar.gz`
...
+gzip compressed data, was "social_auth_gsis-0.5.1.tar", max compression
```

## Comparing `social_auth_gsis-0.5.0.tar` & `social_auth_gsis-0.5.1.tar`
...
+-rw-r--r--   0        0        0     4521 2024-03-01 12:27:31.225982 social_auth_gsis-0.5.1/README.md
+-rw-r--r--   0        0        0      418 2024-05-30 23:05:45.179461 social_auth_gsis-0.5.1/pyproject.toml
+-rw-r--r--   0        0        0     4580 2024-03-01 12:27:31.226078 social_auth_gsis-0.5.1/social_auth_gsis/backends.py
+-rw-r--r--   0        0        0     1123 2024-03-01 11:12:54.719026 social_auth_gsis-0.5.1/social_auth_gsis/pipeline/social_auth.py
+-rw-r--r--   0        0        0     5448 1970-01-01 00:00:00.000000 social_auth_gsis-0.5.1/setup.py
+-rw-r--r--   0        0        0     5278 1970-01-01 00:00:00.000000 social_auth_gsis-0.5.1/PKG-INFO
```

### Comparing `social_auth_gsis-0.5.0/README.md` & `social_auth_gsis-0.5.1/README.md`

 * *Files identical despite different names*

### Comparing `social_auth_gsis-0.5.0/social_auth_gsis/backends.py` & `social_auth_gsis-0.5.1/social_auth_gsis/backends.py`

 * *Files identical despite different names*

### Comparing `social_auth_gsis-0.5.0/social_auth_gsis/pipeline/social_auth.py` & `social_auth_gsis-0.5.1/social_auth_gsis/pipeline/social_auth.py`

 * *Files identical despite different names*

### Comparing `social_auth_gsis-0.5.0/setup.py` & `social_auth_gsis-0.5.1/setup.py`
...
### Comparing `social_auth_gsis-0.5.0/PKG-INFO` & `social_auth_gsis-0.5.1/PKG-INFO`
