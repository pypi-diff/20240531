# Comparing `tmp/glean_sdk-60.1.1.tar.gz` & `tmp/glean_sdk-60.2.0.tar.gz`
...
### Comparing `glean_sdk-60.1.1/glean-core/LICENSE` & `glean_sdk-60.2.0/glean-core/LICENSE`
...
### Comparing `glean_sdk-60.1.1/glean-core/src/glean_metrics.rs` & `glean_sdk-60.2.0/glean-core/src/glean_metrics.rs`
...
### Comparing `glean_sdk-60.1.1/glean-core/src/metrics/timing_distribution.rs` & `glean_sdk-60.2.0/glean-core/src/metrics/timing_distribution.rs`
...
### Comparing `glean_sdk-60.1.1/glean-core/bundle/src/lib.rs` & `glean_sdk-60.2.0/glean-core/bundle/src/lib.rs`
...
### Comparing `glean_sdk-60.1.1/glean-core/python/glean/net/ping_uploader.py` & `glean_sdk-60.2.0/glean-core/python/glean/net/ping_uploader.py`

 * *Files identical despite different names*

### Comparing `glean_sdk-60.1.1/glean-core/python/glean/pings.yaml` & `glean_sdk-60.2.0/glean-core/python/glean/pings.yaml`

 * *Files identical despite different names*

### Comparing `glean_sdk-60.1.1/glean-core/python/glean/testing/__init__.py` & `glean_sdk-60.2.0/glean-core/python/glean/testing/__init__.py`

 * *Files identical despite different names*

### Comparing `glean_sdk-60.1.1/README.md` & `glean_sdk-60.2.0/README.md`

 * *Files identical despite different names*

### Comparing `glean_sdk-60.1.1/LICENSE` & `glean_sdk-60.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `glean_sdk-60.1.1/PKG-INFO` & `glean_sdk-60.2.0/PKG-INFO`
