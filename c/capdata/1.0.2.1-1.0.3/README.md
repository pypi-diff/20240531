# Comparing `tmp/capdata-1.0.2.1.tar.gz` & `tmp/capdata-1.0.3.tar.gz`
...
+gzip compressed data, was "capdata-1.0.3.tar", last modified: Fri May 31 03:15:42 2024, max compression
```

## Comparing `capdata-1.0.2.1.tar` & `capdata-1.0.3.tar`
...
+drwxrwxrwx   0        0        0        0 2024-05-31 03:15:42.528415 capdata-1.0.3/
+-rw-rw-rw-   0        0        0      130 2024-05-31 03:15:42.527415 capdata-1.0.3/PKG-INFO
+-rw-rw-rw-   0        0        0      502 2024-05-31 03:15:07.000000 capdata-1.0.3/README.md
+drwxrwxrwx   0        0        0        0 2024-05-31 03:15:42.509414 capdata-1.0.3/capdata.egg-info/
+-rw-rw-rw-   0        0        0      130 2024-05-31 03:15:42.000000 capdata-1.0.3/capdata.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      418 2024-05-31 03:15:42.000000 capdata-1.0.3/capdata.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-05-31 03:15:42.000000 capdata-1.0.3/capdata.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       31 2024-05-31 03:15:42.000000 capdata-1.0.3/capdata.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       13 2024-05-31 03:15:42.000000 capdata-1.0.3/capdata.egg-info/top_level.txt
+drwxrwxrwx   0        0        0        0 2024-05-31 03:15:42.513414 capdata-1.0.3/data/
+-rw-rw-rw-   0        0        0       39 2022-07-29 01:19:04.000000 capdata-1.0.3/data/__init__.py
+-rw-rw-rw-   0        0        0     1318 2024-05-31 02:50:56.000000 capdata-1.0.3/data/curve.py
+-rw-rw-rw-   0        0        0     1309 2024-05-31 02:55:42.000000 capdata-1.0.3/data/market.py
+-rw-rw-rw-   0        0        0     1941 2024-05-31 02:55:42.000000 capdata-1.0.3/data/pricing.py
+-rw-rw-rw-   0        0        0      920 2024-05-31 02:51:15.000000 capdata-1.0.3/data/refer.py
+-rw-rw-rw-   0        0        0     3541 2024-05-31 02:55:42.000000 capdata-1.0.3/data/risk.py
+drwxrwxrwx   0        0        0        0 2024-05-31 03:15:42.521417 capdata-1.0.3/request/
+-rw-rw-rw-   0        0        0       80 2024-05-27 10:19:49.000000 capdata-1.0.3/request/__init__.py
+-rw-rw-rw-   0        0        0     1916 2024-05-31 01:45:57.000000 capdata-1.0.3/request/request.py
+-rw-rw-rw-   0        0        0       42 2024-05-31 03:15:42.528415 capdata-1.0.3/setup.cfg
+-rw-rw-rw-   0        0        0      598 2024-05-31 03:15:07.000000 capdata-1.0.3/setup.py
+drwxrwxrwx   0        0        0        0 2024-05-31 03:15:42.526415 capdata-1.0.3/test/
+-rw-rw-rw-   0        0        0     5726 2024-05-31 03:12:54.000000 capdata-1.0.3/test/test_capdata.py
+-rw-rw-rw-   0        0        0     1034 2024-05-31 02:42:04.000000 capdata-1.0.3/test/test_curve.py
+-rw-rw-rw-   0        0        0      691 2024-05-31 01:45:03.000000 capdata-1.0.3/test/test_market.py
+-rw-rw-rw-   0        0        0      975 2024-05-31 01:45:06.000000 capdata-1.0.3/test/test_pricing.py
+-rw-rw-rw-   0        0        0     1194 2024-05-31 01:44:25.000000 capdata-1.0.3/test/test_refer.py
+-rw-rw-rw-   0        0        0     2098 2024-05-31 01:41:43.000000 capdata-1.0.3/test/test_risk.py
```

### Comparing `capdata-1.0.2.1/data/curve.py` & `capdata-1.0.3/data/curve.py`

 * *Files identical despite different names*

### Comparing `capdata-1.0.2.1/data/market.py` & `capdata-1.0.3/data/market.py`
...
### Comparing `capdata-1.0.2.1/data/pricing.py` & `capdata-1.0.3/data/pricing.py`
...
### Comparing `capdata-1.0.2.1/data/refer.py` & `capdata-1.0.3/data/refer.py`

 * *Files identical despite different names*

### Comparing `capdata-1.0.2.1/data/risk.py` & `capdata-1.0.3/data/risk.py`
...
### Comparing `capdata-1.0.2.1/request/request.py` & `capdata-1.0.3/request/request.py`

 * *Files identical despite different names*

### Comparing `capdata-1.0.2.1/setup.py` & `capdata-1.0.3/setup.py`
...
### Comparing `capdata-1.0.2.1/test/test_curve.py` & `capdata-1.0.3/test/test_curve.py`
...
### Comparing `capdata-1.0.2.1/test/test_market.py` & `capdata-1.0.3/test/test_market.py`

 * *Files identical despite different names*

### Comparing `capdata-1.0.2.1/test/test_pricing.py` & `capdata-1.0.3/test/test_pricing.py`

 * *Files identical despite different names*

### Comparing `capdata-1.0.2.1/test/test_refer.py` & `capdata-1.0.3/test/test_refer.py`

 * *Files identical despite different names*

### Comparing `capdata-1.0.2.1/test/test_risk.py` & `capdata-1.0.3/test/test_risk.py`
