# Comparing `tmp/harlequin_databend-0.1.18.tar.gz` & `tmp/harlequin_databend-0.1.2.tar.gz`
...
### Comparing `harlequin_databend-0.1.18/README.md` & `harlequin_databend-0.1.2/README.md`
