# Comparing `tmp/prompt_learner-0.3.0.tar.gz` & `tmp/prompt_learner-0.3.1.tar.gz`
...
### Comparing `prompt_learner-0.3.0/prompt_learner/adapters/adapter.py` & `prompt_learner-0.3.1/prompt_learner/adapters/adapter.py`
