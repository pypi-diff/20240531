# Comparing `tmp/lektricowifi-0.0.31.tar.gz` & `tmp/lektricowifi-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "lektricowifi-0.0.31.tar", last modified: Fri May 31 10:09:58 2024, max compression
...
## Comparing `lektricowifi-0.0.31.tar` & `lektricowifi-0.0.9.tar`

### file list

```diff
@@ -1,22 +1,17 @@
-drwxrwxrwx   0        0        0        0 2024-05-31 10:09:58.410449 lektricowifi-0.0.31/
--rw-rw-rw-   0        0        0     1091 2023-07-10 15:21:51.000000 lektricowifi-0.0.31/LICENSE
--rw-rw-rw-   0        0        0     5945 2024-05-31 10:09:58.409451 lektricowifi-0.0.31/PKG-INFO
--rw-rw-rw-   0        0        0     5368 2023-08-21 15:40:41.000000 lektricowifi-0.0.31/README.md
--rw-rw-rw-   0        0        0      108 2023-07-10 15:21:51.000000 lektricowifi-0.0.31/pyproject.toml
--rw-rw-rw-   0        0        0      758 2024-05-31 10:09:58.414721 lektricowifi-0.0.31/setup.cfg
-drwxrwxrwx   0        0        0        0 2024-05-31 10:09:58.331069 lektricowifi-0.0.31/src/
-drwxrwxrwx   0        0        0        0 2024-05-31 10:09:58.362753 lektricowifi-0.0.31/src/lektricowifi/
--rw-rw-rw-   0        0        0      365 2023-08-14 12:11:44.000000 lektricowifi-0.0.31/src/lektricowifi/__init__.py
--rw-rw-rw-   0        0        0      214 2023-07-10 15:21:51.000000 lektricowifi-0.0.31/src/lektricowifi/exceptions.py
--rw-rw-rw-   0        0        0    15096 2024-05-31 10:01:43.000000 lektricowifi-0.0.31/src/lektricowifi/lektricowifi.py
--rw-rw-rw-   0        0        0     1592 2024-05-31 09:49:47.000000 lektricowifi-0.0.31/src/lektricowifi/models.py
--rw-rw-rw-   0        0        0        0 2024-05-31 09:26:09.000000 lektricowifi-0.0.31/src/lektricowifi/py.typed
-drwxrwxrwx   0        0        0        0 2024-05-31 10:09:58.407448 lektricowifi-0.0.31/src/lektricowifi.egg-info/
--rw-rw-rw-   0        0        0     5945 2024-05-31 10:09:58.000000 lektricowifi-0.0.31/src/lektricowifi.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      445 2024-05-31 10:09:58.000000 lektricowifi-0.0.31/src/lektricowifi.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-31 10:09:58.000000 lektricowifi-0.0.31/src/lektricowifi.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       51 2024-05-31 10:09:58.000000 lektricowifi-0.0.31/src/lektricowifi.egg-info/requires.txt
--rw-rw-rw-   0        0        0       13 2024-05-31 10:09:58.000000 lektricowifi-0.0.31/src/lektricowifi.egg-info/top_level.txt
-drwxrwxrwx   0        0        0        0 2024-05-31 10:09:58.403447 lektricowifi-0.0.31/tests/
--rw-rw-rw-   0        0        0     8434 2023-08-21 13:01:27.000000 lektricowifi-0.0.31/tests/test_mocked_devices.py
--rw-rw-rw-   0        0        0     5639 2023-08-21 15:05:04.000000 lektricowifi-0.0.31/tests/test_online_devices.py
...
### Comparing `lektricowifi-0.0.31/LICENSE` & `lektricowifi-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `lektricowifi-0.0.31/setup.cfg` & `lektricowifi-0.0.9/setup.cfg`
...
-00000030: 310d 0a61 7574 686f 7220 3d20 4c65 6b74  1..author = Lekt
