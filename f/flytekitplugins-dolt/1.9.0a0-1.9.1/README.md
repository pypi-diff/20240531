# Comparing `tmp/flytekitplugins-dolt-1.9.0a0.tar.gz` & `tmp/flytekitplugins-dolt-1.9.1.tar.gz`
...
+gzip compressed data, was "flytekitplugins-dolt-1.9.1.tar", last modified: Mon Aug 28 16:43:04 2023, max compression
```

## Comparing `flytekitplugins-dolt-1.9.0a0.tar` & `flytekitplugins-dolt-1.9.1.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (999)        0 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/
+-rw-r--r--   0 runner    (1001) docker     (999)      777 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (999)      725 2023-08-28 16:42:38.000000 flytekitplugins-dolt-1.9.1/README.md
+drwxr-xr-x   0 runner    (1001) docker     (999)        0 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/flytekitplugins/
+drwxr-xr-x   0 runner    (1001) docker     (999)        0 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/flytekitplugins/dolt/
+-rw-r--r--   0 runner    (1001) docker     (999)      311 2023-08-28 16:42:38.000000 flytekitplugins-dolt-1.9.1/flytekitplugins/dolt/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (999)     3535 2023-08-28 16:42:38.000000 flytekitplugins-dolt-1.9.1/flytekitplugins/dolt/schema.py
+drwxr-xr-x   0 runner    (1001) docker     (999)        0 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (999)      777 2023-08-28 16:43:04.000000 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (999)      387 2023-08-28 16:43:04.000000 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (999)        1 2023-08-28 16:43:04.000000 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (999)       16 2023-08-28 16:43:04.000000 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/namespace_packages.txt
+-rw-r--r--   0 runner    (1001) docker     (999)       50 2023-08-28 16:43:04.000000 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (999)       16 2023-08-28 16:43:04.000000 flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/top_level.txt
+drwxr-xr-x   0 runner    (1001) docker     (999)        0 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/scripts/
+-rw-r--r--   0 runner    (1001) docker     (999)      308 2023-08-28 16:42:38.000000 flytekitplugins-dolt-1.9.1/scripts/flytekit_install_dolt.sh
+-rw-r--r--   0 runner    (1001) docker     (999)       38 2023-08-28 16:43:04.822120 flytekitplugins-dolt-1.9.1/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (999)     1582 2023-08-28 16:43:00.000000 flytekitplugins-dolt-1.9.1/setup.py
```

### Comparing `flytekitplugins-dolt-1.9.0a0/PKG-INFO` & `flytekitplugins-dolt-1.9.1/PKG-INFO`
...
### Comparing `flytekitplugins-dolt-1.9.0a0/README.md` & `flytekitplugins-dolt-1.9.1/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-dolt-1.9.0a0/flytekitplugins/dolt/schema.py` & `flytekitplugins-dolt-1.9.1/flytekitplugins/dolt/schema.py`
...
### Comparing `flytekitplugins-dolt-1.9.0a0/flytekitplugins_dolt.egg-info/PKG-INFO` & `flytekitplugins-dolt-1.9.1/flytekitplugins_dolt.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-dolt-1.9.0a0/setup.py` & `flytekitplugins-dolt-1.9.1/setup.py`
