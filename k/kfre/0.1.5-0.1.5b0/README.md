# Comparing `tmp/kfre-0.1.5.tar.gz` & `tmp/kfre-0.1.5b0.tar.gz`
...
+gzip compressed data, was "kfre-0.1.5b0.tar", last modified: Fri May 31 15:36:44 2024, max compression
```

## Comparing `kfre-0.1.5.tar` & `kfre-0.1.5b0.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-31 15:36:44.988011 kfre-0.1.5b0/
+-rw-r--r--   0 runner    (1001) docker     (127)     1243 2024-05-31 15:36:35.000000 kfre-0.1.5b0/LICENSE.md
+-rw-r--r--   0 runner    (1001) docker     (127)     5549 2024-05-31 15:36:44.988011 kfre-0.1.5b0/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)    23883 2024-05-31 15:36:35.000000 kfre-0.1.5b0/README.md
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-31 15:36:44.988011 kfre-0.1.5b0/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)     1299 2024-05-31 15:36:35.000000 kfre-0.1.5b0/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-31 15:36:44.984011 kfre-0.1.5b0/src/
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-31 15:36:44.988011 kfre-0.1.5b0/src/kfre/
+-rw-r--r--   0 runner    (1001) docker     (127)     1827 2024-05-31 15:36:35.000000 kfre-0.1.5b0/src/kfre/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)    26190 2024-05-31 15:36:35.000000 kfre-0.1.5b0/src/kfre/main.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-31 15:36:44.988011 kfre-0.1.5b0/src/kfre.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     5549 2024-05-31 15:36:44.000000 kfre-0.1.5b0/src/kfre.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      226 2024-05-31 15:36:44.000000 kfre-0.1.5b0/src/kfre.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-31 15:36:44.000000 kfre-0.1.5b0/src/kfre.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       28 2024-05-31 15:36:44.000000 kfre-0.1.5b0/src/kfre.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        5 2024-05-31 15:36:44.000000 kfre-0.1.5b0/src/kfre.egg-info/top_level.txt
```

### Comparing `kfre-0.1.5/LICENSE.md` & `kfre-0.1.5b0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `kfre-0.1.5/PKG-INFO` & `kfre-0.1.5b0/PKG-INFO`
...
+Version: 0.1.5b0
+Summary: APython library for estimating kidney failure risk using the KFRE model developed by Tangri et al.
...
### Comparing `kfre-0.1.5/README.md` & `kfre-0.1.5b0/README.md`

 * *Files identical despite different names*

### Comparing `kfre-0.1.5/setup.py` & `kfre-0.1.5b0/setup.py`
...
### Comparing `kfre-0.1.5/src/kfre/__init__.py` & `kfre-0.1.5b0/src/kfre/__init__.py`
...
### Comparing `kfre-0.1.5/src/kfre/main.py` & `kfre-0.1.5b0/src/kfre/main.py`

 * *Files identical despite different names*

### Comparing `kfre-0.1.5/src/kfre.egg-info/PKG-INFO` & `kfre-0.1.5b0/src/kfre.egg-info/PKG-INFO`
